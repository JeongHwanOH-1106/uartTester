...
{
	{
		XPAR_SENSOR_MISC_AXI_GPIO_1_DEVICE_ID,
		XPAR_SENSOR_MISC_AXI_GPIO_1_BASEADDR,
		XPAR_SENSOR_MISC_AXI_GPIO_1_INTERRUPT_PRESENT,
		XPAR_SENSOR_MISC_AXI_GPIO_1_IS_DUAL
	},
	{
